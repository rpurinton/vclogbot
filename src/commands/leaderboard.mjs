...
// Command handler for /leaderboard with dependency injection
export default function createLeaderboardHandler({ log: injectedLog = log, db: injectedDb = db, formatTime: injectedFormatTime = formatTime, getMsg: injectedGetMsg = getMsg } = {}) {
