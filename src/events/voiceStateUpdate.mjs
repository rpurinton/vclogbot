...
// Event handler for voiceStateUpdate with dependency injection
export default function createVoiceStateUpdateHandler({ db: injectedDb = db, log: injectedLog = log, timerFunction: injectedTimerFunction = timerFunction, getCurrentTimestamp: injectedGetCurrentTimestamp = getCurrentTimestamp, messageService = global.messageService } = {}) {
